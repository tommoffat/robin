...
DATA_INTERPRETATION_CONTENT_MESSAGE = (
    ...
    "1.  **List of materials tested in data:** List out all the materials tested in this dataset.\n"
    ...
    "The **List of materials tested in data** should be in a comma separated string. "
...
ANALYSIS_QUERIES = {
    "flow_cytometry": (
        ...
        "pigment epithelial cells across different material treatments.\n"
        "Use the metadata file to match well positions  (e.g., A1) with their "
        "corresponding material treatments and plate information.\n"
        ...
        "Determine if there are any material treatments that significantly increased "
        "signal compared to DMSO control. Perform a suitable statistical test to "
        "compare the material treatments to the DMSO control. Consider carefully the "
        ...
        "the following columns: “material”, “mean_intensity”, “std_error”, “p_val”, "
        "“adj_p_val”. Include control labelled as “DMSO control” under the column "
        "“material”. Do not include other columns in the CSV. \n\n"
...
CONSENSUS_QUERIES = {
    "flow_cytometry": (
        ...
        "method to combine the p values. The aim is to determine whether any material "
        ...
        "the following columns: “material”, “mean_intensity”, “std_error”.\n\n"
        "Generate a barplot showing the average Alexa Fluor 647 fluorescence values "
        "for each material treatment and DMSO control with error bars showing the standard "
...
ASSAY_RANKING_SYSTEM_PROMPT = (
    "You are an experienced materials development committee member, with broad scientific "
...
CANDIDATE_QUERY_GENERATION_SYSTEM_MESSAGE = (
    ...
    "(genetic, functional) linking it *specifically* to the core materials problem.\n"
    "2.  **Relevant Experimental Evidence:** Supporting data exists from "
    "relevant material systems or, ideally, preliminary demonstrations (even if from related "
    "applications).\n"
...
CANDIDATE_GENERATION_SYSTEM_MESSAGE = (
    ...
    "<CANDIDATE START>\n"
    "CANDIDATE: The specific material proposed. Must be a single approach, not a "
    ...
    "(a commercially available material or component, mention catalog numbers if applicable) will advance "
    "{research_topic} at a fundamental level.\n"
...
CANDIDATE_RANKING_SYSTEM_PROMPT = (
    ...
    "(e.g., in situ tests or prototype evaluations for the material or material class, especially if successful "
    ...
    "contradictory data for this material/class in relevant contexts? This is a strong deterrent.\n"
    ...
    "fundamental materials mechanisms over indirect or downstream effects, unless the "
    "indirect effect is exceptionally well-supported and highly plausible.\n"
    "    *   **Specificity & Target Property:** Is the target property or mechanism well-defined? "
    "Is its role central to advancing {research_topic}? Specific pathway/target "
    ...
    "beneficial or detrimental in this specific research context.\n\n"
    ...
    "outcomes related to the research goal for {research_topic} defined?\n"
